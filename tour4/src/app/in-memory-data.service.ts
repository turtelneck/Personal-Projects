  ...
  createDb() {
    const boxes: Box[] = [
      { 
        ...
        longdesc: 'The main offering of Stack & Stō, the box that started it all. We\'ve been using this box to hoodwink consumers for as long as we\'ve been in business. Our system is simple—we claim to offer a look at the future of storage, you make your purchase, and you discover that our boxes are just overpriced and kind of useless. We commit to creating a transaction guaranteed to disappoint all but the most moronic customers. We\'ll do anything we can to deliver on that promise, especially if it means selling very expensive products that blatantly fail to fulfil even the most basic of our marketing\'s implicit promises.',
